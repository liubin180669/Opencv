...
int main13_2(int argc, char** argv) {
	argv[0] = "D:/opencv/test_source/test3.jpg";
	argv[1] = "D:/opencv/test_source/meinv.jpg";
	argv[2] = "D:/opencv/test_source/t1.jpg";
	argv[3] = "D:/opencv/test_source/test2.jpg";
	argv[4] = "D:/opencv/test_source/fj.jpg";
	//if (argc != 5) { help(argv); return -1; }
	vector<cv::Mat> src(5);
	cv::Mat tmp;
	int i;

	tmp = cv::imread("D:/opencv/test_source/test3.jpg", 1);
	if (tmp.empty()) {
		cerr << "Error on reading image 1, \n" << endl;
